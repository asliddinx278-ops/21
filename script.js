...
// ============================================================
// AI CARGO ASSISTANT — real Google Gemini API integration via backend
...
const translations = {
  ru: {
    ...
    'ai.p1': 'Google Gemini API — умная классификация типа груза',
    ...
    'aip.disclaimer': 'Защищено reCAPTCHA · Данные конфиденциальны · Реальная интеграция с Google Gemini API',
  },
  en: {
    ...
    'ai.p1': 'Google Gemini API — smart cargo type classification',
    ...
    'aip.disclaimer': 'Protected by reCAPTCHA · Data confidential · Real integration with Google Gemini API',
  },
  uz: {
    ...
    'ai.p1': 'Google Gemini API — yuk turini aqlli klassifikatsiya qilish',
    ...
    'aip.disclaimer': 'reCAPTCHA bilan himoyalangan · Ma\'lumotlar maxfiy · Google Gemini API bilan haqiqiy integratsiya',
  },
  zh: {
    'hdr.sub': '航空货运 · 中转 · 中亚',
    ...
    'ai.p1': 'Google Gemini API —— 智能货物类型分类',
    ...
    'aip.cta_rfq': '填写完整询价表',
    'aip.disclaimer': '受reCAPTCHA保护 · 数据保密 · 与Google Gemini API的真实集成',
  }
};
